...
=============================================================================
Show Server Configuration Metadata -  Rackspace Cloud Orchestration Developer Guide
=============================================================================

Show Server Configuration Metadata
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <get-show-server-configuration-metadata-v1-tenant-id-software-deployments-metadata-server-id.html#request>`__
`Response <get-show-server-configuration-metadata-v1-tenant-id-software-deployments-metadata-server-id.html#response>`__
...
+--------------------------+-------------------------+-------------------------+
|{server_id}               |*(Required)*             |The ID of the server for |
|                          |                         |which to fetch           |
