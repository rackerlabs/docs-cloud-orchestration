...
=============================================================================
Update Deployment -  Rackspace Cloud Orchestration Developer Guide
=============================================================================

Update Deployment
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <put-update-deployment-v1-tenant-id-software-deployments-deployment-id.html#request>`__
`Response <put-update-deployment-v1-tenant-id-software-deployments-deployment-id.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|config_id                 |*(Required)*             |ID of the software       |
...
|                          |                         |deployment.              |
+--------------------------+-------------------------+-------------------------+
|action                    |*(Required)*             |Current stack action in  |
...
|                          |                         |status.                  |
+--------------------------+-------------------------+-------------------------+
|output_values             |*(Required)*             |Map of output values for |
|                          |                         |the deployment, as       |
|                          |                         |signalled from the       |
|                          |                         |server.                  |
+--------------------------+-------------------------+-------------------------+
