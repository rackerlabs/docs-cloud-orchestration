...
=============================================================================
Preview Stack -  Rackspace Cloud Orchestration Developer Guide
=============================================================================

Preview Stack
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <post-preview-stack-v1-tenant-id-stacks-preview.html#request>`__
`Response <post-preview-stack-v1-tenant-id-stacks-preview.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|parent                    |*(Required)*             |The stack ID of the      |
|                          |                         |parent stack, if this is |
|                          |                         |a nested stack.          |
+--------------------------+-------------------------+-------------------------+
|id                        |*(Required)*             |The stack ID.            |
+--------------------------+-------------------------+-------------------------+
...
|                          |                         |stack.                   |
+--------------------------+-------------------------+-------------------------+
|template_description      |*(Required)*             |A description of the     |
|                          |                         |template that defines    |
|                          |                         |the stack.               |
+--------------------------+-------------------------+-------------------------+
|timeout_mins              |*(Required)*             |Timelines for stack      |
|                          |                         |creation.                |
+--------------------------+-------------------------+-------------------------+
...
|                          |                         |``True``.                |
+--------------------------+-------------------------+-------------------------+
|capabilities              |*(Required)*             |List of stack            |
|                          |                         |capabilities for stack.  |
+--------------------------+-------------------------+-------------------------+
|notification_topics       |*(Required)*             |List of notification     |
|                          |                         |topics for stack.        |
+--------------------------+-------------------------+-------------------------+
|updated_time              |*(Required)*             |Time of last stack       |
...
|                          |                         |designator.              |
+--------------------------+-------------------------+-------------------------+
|stack_owner               |*(Required)*             |Stack owner name.        |
+--------------------------+-------------------------+-------------------------+
|parameters                |*(Required)*             |List of parameters       |
|                          |                         |defined for the stack.   |
+--------------------------+-------------------------+-------------------------+
|resources                 |*(Required)*             |List of stack resources. |
+--------------------------+-------------------------+-------------------------+
